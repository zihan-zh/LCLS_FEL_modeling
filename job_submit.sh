...
#SBATCH --account=ad:ard-online #ad:beamphysics  # @ad:beamphysics    # Account name ad:beamphysics ad:ard-online@ampere  
...
#SBATCH --error=./slurm_outputs/%j.log
#SBATCH --mem=256G
#SBATCH --ntasks=1
# OpenMP settings
...
python train_fel_model.py --epochs 100 --batch_size 256 \
    --save_every 30 \
    --subsample_step 1 \
    # --resume_from /sdf/scratch/users/z/zihanzhu/fel_tuning/checkpoints/19272705/epoch_002.pt #--model_path ./autoencoder_20250220_1950.pth
